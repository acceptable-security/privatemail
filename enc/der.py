...
class DerObject(object):
        ...
        def __init__(self, asn1Id=None, payload='', implicit=None, constructed=False):
        ...
        def encode(self):
                ...
                # and contents octets
                return chr(self._idOctet) + self._lengthOctets() + self.payload

        def _decodeLen(self, s):
                """Decode DER length octets from a file."""

                length = ord(s.read_byte())
                if length<=127:
                        return length
...
class DerInteger(DerObject):
        ...
        def __init__(self, value=0, implicit=None):
                ...
                DerObject.__init__(self, 0x02, '', implicit, False)
        ...
        def encode(self):
                ...
                self.payload = ''
                while True:
                    self.payload = chr(number&255) + self.payload
                    if 128 <= number <= 255:
                        self.payload = chr(0x00) + self.payload
                    if -128 <= number <= 255:
                        break
                    number >>= 8
        ...
        def _decodeFromStream(self, s):
                ...
                for i in self.payload:
                    ...
                    self.value += ord(i)
                    bits <<= 8
                if self.payload and ord(self.payload[0]) & 0x80:
                    self.value -= bits
...
class DerSequence(DerObject):
        ...
        def __init__(self, startSeq=None, implicit=None):
                ...
                DerObject.__init__(self, 0x10, '', implicit, True)
                if startSeq==None:
                    self._seq = []
                else:
                    self._seq = startSeq
...
class DerNull(DerObject):
    ...
    def __init__(self):
        ...
        DerObject.__init__(self, 0x05, '', False)
...
class DerObjectId(DerObject):
    ...
    def __init__(self, value='', implicit=None):
        ...
        """
        DerObject.__init__(self, 0x06, '', implicit, False)
    ...
    def encode(self):
        ...
        self.payload = chr(40*comps[0]+comps[1])
        for v in comps[2:]:
            enc = []
            while v:
    ...
    def _decodeFromStream(self, s):
        ...
        # Derive self.value from self.payload
        p = BytesIO_EOF(self.payload)
        comps = list(map(str, divmod(ord(p.read_byte()),40)))
        v = 0
        try:
            while True:
                c = p.read_byte()
...
class DerBitString(DerObject):
    ...
    def __init__(self, value='', implicit=None):
        ...
        """
        DerObject.__init__(self, 0x03, '', implicit, False)
    ...
    def _decodeFromStream(self, s):
        ...
        if self.payload and ord(self.payload[0])!=0:
...
class DerSetOf(DerObject):
    ...
    def __init__(self, startSet=None, implicit=None):
        ...
        """
        DerObject.__init__(self, 0x11, '', implicit, True)
        self._seq = []
